...
**LogLayer** provides a fluent, structured logging API that sits on top of your logging library of choice. Start with `console`, swap to Pino, Winston, or a cloud provider later — without changing your application code.
